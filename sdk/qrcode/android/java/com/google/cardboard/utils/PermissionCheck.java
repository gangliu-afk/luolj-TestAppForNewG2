...
public final class PermissionCheck {
    ...
    public static List<String> missingPermissions(Context context, String[] expectations) throws IllegalArgumentException, NameNotFoundException {
        return missingPermissions(context, (List)(new ArrayList(Arrays.asList(expectations))));
    }

    public static List<String> missingPermissions(Context context, List<String> expectations) throws IllegalArgumentException, NameNotFoundException {
